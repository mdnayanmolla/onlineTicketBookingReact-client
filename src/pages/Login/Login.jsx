            ...
            <div className="px-[2%]">
                <div className="py-10">
                    <form onSubmit={handleSubmit(onSubmit)} className="">
                        ...
                        <Link to='/home' type="submit" className='mt-7 text-sm bg-[#dc3545]   rounded-md text-center w-full text-white py-3 hover:bg-[#c82333] duration-500'>Sign In </Link>
                    </form>
                    <div className="w-1/4 mx-auto ">  <div className="divider">OR</div></div>
                     ...
                     <p className="text-center pt-3 text-sm"> Not a member? <Link to='/signup' className="text-[#dc3545]">Sign Up</Link></p>
                  </div>
                </div>
        </div>
    );
